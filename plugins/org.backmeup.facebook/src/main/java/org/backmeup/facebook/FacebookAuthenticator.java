...
public class FacebookAuthenticator implements OAuthBased {
	...
	public String createRedirectURL(Properties inputProperties, String callback) {
		...
		return "https://www.facebook.com/dialog/oauth?client_id="
				...
				+ "user_birthday,user_photos,read_stream,user_about_me,user_activities,user_education_history,user_events,user_groups,user_hometown,user_interests,user_likes,user_location,user_notes,user_questions,user_relationships,user_relationship_details,user_religion_politics,user_status,user_subscriptions,user_videos,user_website,user_work_history,email,read_friendlists,friends_photos"; // TODO add more permissions
	}
